...
const FLEET_DATA = {
  ...
  minivan: {
    en: { title: 'XL Vehicles', avail: '5 vehicles available' },
    es: { title: 'Vehículos XL', avail: '5 vehículos disponibles' },
    cars: [
      {
        name:  'Honda Odyssey',
        seats: 8,
...
const I18N = {
  en: {
    ...
    'fleet.minivan.desc': 'The biggest vehicles in our fleet — perfect for large groups, families, and special occasions. From spacious minivans to full-size luxury SUVs, all seating up to 8 passengers.',
    ...
    'reviews.r1.name':  'Francesco Pietrapiana',
    'reviews.r1.loc':   'Google Review',
    'reviews.r2.text':  '"Very professional service and spotless, new cars! I rented a van for a week and everything was great. The customer service team was top-notch from the moment I contacted them until the very end. 100% recommended!"',
    'reviews.r2.name':  'Mariano Leon',
    'reviews.r2.loc':   'Google Review',
    'reviews.r3.text':  '"I came for two weeks with my daughter and rented two cars — one for Miami and another for the round trip to Orlando. They were punctual with every delivery and always available to help."',
    'reviews.r3.name':  'Erika Saavedra Pinedo',
    'reviews.r3.loc':   'Google Review',
    'reviews.r4.text':  '"Excellent service!! They delivered to the Port of Miami exactly when I needed it. New and reliable vehicles!! Great service from the entire team."',
    'reviews.r4.name':  'Renato Mendoza',
    'reviews.r4.loc':   'Google Review',
    'reviews.r5.text':  '"Excellent! The cars were perfect. Arriving at the airport and having the car ready without waiting in any lines was a breeze. The service was incredibly friendly. Highly recommend!"',
    'reviews.r5.name':  'Claudia Vasquez',
    'reviews.r5.loc':   'Google Review',
    'reviews.r6.text':  '"You save money and time at the airport. Super efficient service! I highly recommend it."',
    'reviews.r6.name':  'Dr. Sergio Valverde',
    'reviews.r6.loc':   'Google Review · Local Guide',
    ...
    'faq.a1': "Driver must be 25 or older with a valid driver's license (any country, Latin alphabet) and a major credit card in their own name. We may request a refundable security deposit at pickup.",
    'faq.q2': 'Is insurance included?',
    'faq.a2': 'Yes — basic collision and third-party coverage are included on every rental. Additional protection options can be added on request.',
  ...
  es: {
    ...
    'fleet.minivan.desc': 'Los vehículos más grandes de nuestra flota — perfectos para grupos grandes, familias y ocasiones especiales. Desde minivans espaciosas hasta SUVs de lujo, todos con capacidad para hasta 8 pasajeros.',
    ...
    'reviews.r2.text':  '"Servicio muy profesional y autos impecables y nuevos! Alquilé una camioneta por una semana y todo estuvo genial. El trato del equipo de atención al cliente fue de primera desde el primer contacto hasta el final. ¡Lo recomiendo 100%!"',
    'reviews.r2.name':  'Mariano Leon',
    'reviews.r2.loc':   'Reseña de Google',
    'reviews.r3.text':  '"Vine por dos semanas con mi hija y renté dos autos — uno para Miami y otro para el viaje de ida y vuelta a Orlando. Fueron puntuales en cada entrega y siempre estuvieron disponibles para ayudar."',
    'reviews.r3.name':  'Erika Saavedra Pinedo',
    'reviews.r3.loc':   'Reseña de Google',
    'reviews.r4.text':  '"¡Excelente Servicio!! Esta vez me lo dejaron en el Puerto de Miami con los horarios que necesitaba. Vehículos nuevos y sobre todo confiables. Excelente servicio de todo el equipo."',
    'reviews.r4.name':  'Renato Mendoza',
    'reviews.r4.loc':   'Reseña de Google',
    'reviews.r5.text':  '"¡Excelente! Los carros perfectos. Llegar al aeropuerto y tener el carro ya listo sin hacer ninguna cola fue genial. El trato súper amable. ¡Lo súper recomiendo!"',
    'reviews.r5.name':  'Claudia Vasquez',
    'reviews.r5.loc':   'Reseña de Google',
    'reviews.r6.text':  '"Ahorras dinero y tiempo en el aeropuerto. ¡El servicio súper eficiente! Lo recomiendo."',
    'reviews.r6.name':  'Dr. Sergio Valverde',
    'reviews.r6.loc':   'Reseña de Google · Guía Local',
    ...
    'faq.a1': 'El conductor debe tener 25 años o más, una licencia de conducir vigente (cualquier país, alfabeto latino) y una tarjeta de crédito a su nombre. Podemos pedir un depósito reembolsable al momento de la entrega.',
    'faq.q2': '¿El seguro está incluido?',
    'faq.a2': 'Sí — la cobertura básica de colisión y daños a terceros está incluida en cada renta. Hay opciones adicionales si las necesitas.',
    ...
    'faq.q5': '¿Puedo cancelar o cambiar mi reserva?',
    'faq.a5': 'Sí. Cambios o cancelaciones gratuitos hasta 24 horas antes de la entrega. Dentro de las 24 horas, puede aplicarse un cargo pequeño. Escríbenos por WhatsApp — es la forma más rápida.',
    'faq.q6': '¿Qué incluye cada cotización?',
    'faq.a6': 'Todo — sin sorpresas al recoger o devolver el auto. Cada cotización incluye: seguro completo de colisión y responsabilidad civil; millaje ilimitado (maneja todo lo que necesites); todos los peajes cubiertos (sin necesidad de SunPass); un conductor adicional registrado sin costo extra; y los cargos de entrega en aeropuerto, puerto y hotel. El precio de tu cotización es exactamente lo que pagas. Sin excepciones.',
...
function buildModalContent(category) {
  ...
  const carCards = data.cars.map(car => {
    const msg = isEs
      ? `Hola Pick & Go — me interesa rentar el ${car.name}. ¿Pueden compartirme disponibilidad?`
      : `Hi Pick & Go — I'm interested in renting the ${car.name}. Can you share availability and pricing?`;
    return `
      <div class="modal-car-card">
        ...
        <div class="modal-car-body">
          ...
          <a href="${waBase}${encodeURIComponent(msg)}" target="_blank" rel="noopener" class="btn btn-modal-car">
            ${requestLbl}
          </a>
        </div>
      </div>`;
