...
const I18N = {
  en: {
    ...
    'reviews.r1.text':  '"Rented a RAV4 for a week in Miami. They met me right at MIA arrivals — no wait, no shuttle. Car was spotless. Will definitely book again."',
    'reviews.r1.name':  'Carlos M.',
    'reviews.r1.loc':   'Miami, FL',
    'reviews.r2.text':  '"Best rental in South Florida. Quick WhatsApp reply, no hidden fees, and the Suburban was perfect for our family of 6. Highly recommend."',
    'reviews.r2.name':  'Jennifer T.',
    'reviews.r2.loc':   'Fort Lauderdale, FL',
    'reviews.r3.text':  '"Booked via WhatsApp in under 2 minutes. Great price on the Tiguan for our road trip. Super professional and responsive. 10/10."',
    'reviews.r3.name':  'Mike R.',
    'reviews.r3.loc':   'Atlanta, GA',
    'reviews.r4.text':  '"Renté la Odyssey para un viaje familiar. Precio justo, respuesta inmediata por WhatsApp y el auto estaba en perfectas condiciones. 100% recomendado."',
    'reviews.r4.name':  'Ana L.',
    'reviews.r4.loc':   'Miami Beach, FL',
  ...
  es: {
    ...
    'reviews.r1.text':  '"Renté un RAV4 por una semana en Miami. Me recibieron en llegadas de MIA — sin esperas, sin shuttle. El auto estaba impecable. Definitivamente volveré."',
    'reviews.r1.name':  'Carlos M.',
    'reviews.r1.loc':   'Miami, FL',
    'reviews.r2.text':  '"La mejor renta en el Sur de Florida. Respuesta rápida por WhatsApp, sin cargos ocultos, y la Suburban fue perfecta para nuestra familia de 6. Lo recomiendo.",',
    'reviews.r2.name':  'Jennifer T.',
    'reviews.r2.loc':   'Fort Lauderdale, FL',
    'reviews.r3.text':  '"Reservé por WhatsApp en menos de 2 minutos. Buen precio en la Tiguan para nuestro road trip. Muy profesionales y atentos. 10/10."',
    'reviews.r3.name':  'Mike R.',
    'reviews.r3.loc':   'Atlanta, GA',
    'reviews.r4.text':  '"Renté la Odyssey para un viaje familiar. Precio justo, respuesta inmediata por WhatsApp y el auto estaba en perfectas condiciones. 100% recomendado."',
    'reviews.r4.name':  'Ana L.',
